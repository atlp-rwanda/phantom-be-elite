...
export const getAllDrivers = async(req, res) => {
    ...
    if (!driver.rowCount) {
        return res
            .status(400)
            .send({ success: false, message: `No driver profile found` });
    }
